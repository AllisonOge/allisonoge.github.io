...
tags: docker gnuradio fitcortexlab research
categories: dev-ops
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/fit-cortexlab.jpg" title="fit cortex lab image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Fit Cortex Lab
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/sdr_distribution.png" title="sdr distribution" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    SDR Distribution
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/sdr_distribution_2.png" title="sdr distribution" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    SDR Distribution showing distance between nodes
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/rx_ofdm_flowgraph.png" title="rx ofdm flowgraph" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    <code>rx_ofdm</code> flowgraph
</div>
