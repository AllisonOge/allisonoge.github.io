...
tags: docker gnuradio fitcortextlab research
categories: dev-ops
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/clb-for-devops.png" title="devops with gnuradio and docker" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Dockering GNU Radio
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/docker-pull.png" title="docker pull console" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Console for <em>docker pull m1mbert/cxlb-gnuradio-3.10:1.2</em> command
</div>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/verify-successful-pull.png" title="docker images console" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Verify successfull image pull with <em>docker images</em> command
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/run-docker-instance.png" title="docker run console" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Console for <em>docker run -dit --net=host --expose 2222 --privileged m1mbert/cxlb-gnuradio-3.10:1.2</em> command
</div>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/verify-successful-run.png" title="docker ps console" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Verify successful docker instance run with <em>docker ps</em> command
</div>
...
I hope this blog post has been insightful and valuable to you. Feel free to engage with the post in the comment section below. Au revoir &#128075;. 
